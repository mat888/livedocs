...
class PlaceUI {
  ...
  onMousemoveOverForeground(event) {
    ...
    if (this.mousedown) {
      if (this.mode === "view") {
        ...
        console.error("Unexpected mode: " + this.mode);
      }
    }
  ...
  moveForeground(event) {
    ...
    } else if (this.gridApparentPosition.left < window.innerWidth / 2 - this.gridSize * this.currentScale) {
      this.gridApparentPosition.left = window.innerWidth / 2 - this.gridSize * this.currentScale;
    } else if (this.gridApparentPosition.top  < window.innerHeight / 2 - this.gridSize * this.currentScale) {
      this.gridApparentPosition.top  = window.innerHeight / 2 - this.gridSize * this.currentScale;
    }
